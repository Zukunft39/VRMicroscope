...
public sealed class SpatialFrequencyDiffractionPatternGraphic : MaskableGraphic
{
    ...
    public void SetPattern(float normalized, int orderCount, float alpha)
    {
    ...
    protected override void OnPopulateMesh(VertexHelper vertexHelper)
    {
        ...
        AddCircle(vertexHelper, Vector2.zero, spotRadius * 0.82f, new Color(1f, 1f, 1f, patternAlpha));
